<p><b style="font-size:38px;">AI vs Human Text Detection System</b></p>

<p><b style="font-size:30px;">Overview</b></p>
...
<p><b style="font-size:30px;">Objectives</b></p>
...
<p><b style="font-size:24px;">Data Preprocessing</b></p>

- Convert text to lowercase  
- Remove punctuation  
- Encode labels: AI - 1, Human - 0  

<p><b style="font-size:24px;">Feature Engineering</b></p>
...
<p><b style="font-size:30px;">Model Evaluation</b></p>
...
<p><b style="font-size:30px;">Intelligent Decision Layer</b></p>
...
<p><b style="font-size:30px;">Frontend</b></p>
...
<p><b style="font-size:30px;">Future Work</b></p>
